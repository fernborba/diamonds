    ...
    <form action="/profile/{{ $user->id }}" enctype="multipart/form-data" method="post">
        ...
        <div class="row">
            <div class="col-8 offset-2">
                ...
                <div class="row"><div class="h1">Edit profile</div></div>
            ...
            <div class="col-8 offset-2">
                <label for="src" class="col-md-4 col-form-label">{{ __('Profile file') }}</label>
        ...
        <div class="row pt-3">
            <div class="col-8 offset-2">
                <button class="btn btn-primary p-1">Save profile</button>
            </div>
        </div>
